...
# parsed section:
# section = {
#    'cluster': {'minions': [('ClusState', 'RUNNING', None)]},
#    'group': {'ClusterService': [('State', 'OFFLINE', 'minions'),
#                                  ('Frozen', '0', 'minions'),
#                                  ('TFrozen', '0', 'minions')],
#              'lan': [('State', 'ONLINE', 'minions'),
#                       ('Frozen', '0', 'minions'),
#                       ('TFrozen', '0', 'minions')],
#              'nepharius': [('State', 'ONLINE', 'minions'),
#                             ('Frozen', '0', 'minions'),
#                             ('TFrozen', '1', 'minions')],
#              'omd': [('State', 'ONLINE', 'minions'),
#                       ('Frozen', '1', 'minions'),
#                       ('TFrozen', '0', 'minions')]},
#    'resource': {'cs_ip': [('State', 'OFFLINE', 'minions')],
#                  'cs_proxy': [('State', 'ONLINE', 'minions')],
#                  'lan_nic': [('State', 'ONLINE', 'minions')],
#                  'lan_phantom': [('State', 'ONLINE', 'minions')],
#                  'nepharius_dr': [('State', 'ONLINE', 'minions')],
#                  'nepharius_mrs': [('State', 'ONLINE', 'minions')],
#                  'omd_apache': [('State', 'ONLINE', 'minions')],
#                  'omd_appl': [('State', 'ONLINE', 'minions')],
#                  'omd_dg': [('State', 'ONLINE', 'minions')],
#                  'omd_proxy': [('State', 'ONLINE', 'minions')],
#                  'omd_srdf': [('State', 'ONLINE', 'minions')],
#                  'omd_uc4ps1_agt': [('State', 'ONLINE', 'minions')],
#                  'omdp_ip': [('State', 'ONLINE', 'minions')],
#                  'omdp_mnt': [('State', 'ONLINE', 'minions')]},
#    'system': {'dave': [('SysState', 'RUNNING', 'minions')],
#                'stuart': [('SysState', 'RUNNING', 'minions')]}}
