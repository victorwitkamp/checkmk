...
@pytest.mark.parametrize('string_table, discovery_results, items_params_results', [
    (
        [
            [
                'interface GTB1020-2-CL_mgmt', 'comment -', 'use-failover-group unused',
                'address 191.128.142.33', 'dns-domain-name none', 'is-auto-revert false',
                'lif-uuid d3233231-a1d3-12e6-a4ff-00a0231e0e11', 'firewall-policy mgmt',
                'vserver FSS2220-2-CL', 'role cluster_mgmt', 'netmask-length 24',
                'data-protocols.data-protocol none', 'operational-status up', 'ipspace Default',
                'netmask 255.255.254.0', 'failover-policy broadcast_domain_wide',
                'home-node FSS2220-2', 'address-family ipv4', 'current-port e0f-112',
                'current-node FSS2220-2', 'is-dns-update-enabled false', 'subnet-name MGMT',
                'listen-for-dns-query false', 'administrative-status up',
                'failover-group MGMT-Netz', 'home-port e0f-112', 'is-home true',
                'operational-speed 1000', 'send_data 0', 'send_errors 0', 'link-status up',
                'recv_errors 0', 'send_packet 0', 'recv_packet 0',
                'instance_name FSS2220-2-CL_mgmt', 'recv_data 0'
            ],
            [
                'interface GTB1020-2_ic1', 'comment -', 'use-failover-group unused',
                'address 10.12.1.4', 'dns-domain-name none', 'is-auto-revert false',
                'lif-uuid sdfd13d4d-82db-12c5-a2ff-00a123e0e49', 'firewall-policy intercluster',
                'vserver FSS2220-1-DL', 'role intercluster', 'netmask-length 24',
                'data-protocols.data-protocol none', 'operational-status up', 'ipspace Default',
                'netmask 255.255.244.0', 'failover-policy local_only', 'home-node FSS2220-2',
                'address-family ipv4', 'current-port e0f-1137', 'current-node FSS2220-2',
                'listen-for-dns-query false', 'administrative-status up',
                'failover-group Intercluster', 'home-port e0f-2231', 'is-home true',
                'operational-speed 1000', 'send_data 142310234', 'send_errors 0',
                'link-status up', 'recv_errors 0', 'send_packet 2223111', 'recv_packet 2223411',
                'instance_name FSS2220_ic1', 'recv_data 122333190'
            ],
        ],
        [
            Service(
    ...
    (
        [
            [
                'interface e0a', 'mediatype auto-1000t-fd-up', 'flowcontrol full',
                'mtusize 9000', 'ipspace-name default-ipspace', 'mac-address 01:b0:89:22:df:01'
            ],
            [
                'interface e0b', 'mediatype auto-1000t-fd-up', 'flowcontrol full',
                'mtusize 9000', 'ipspace-name default-ipspace', 'mac-address 01:b0:89:22:df:01'
            ],
            [
                'interface e0c', 'ipspace-name default-ipspace', 'flowcontrol full',
                'mediatype auto-1000t-fd-up', 'mac-address 01:b0:89:22:df:02'
            ],
            [
                'interface e0d', 'ipspace-name default-ipspace', 'flowcontrol full',
                'mediatype auto-1000t-fd-up', 'mac-address 01:b0:89:22:df:02'
            ],
            [
                ...
                'send_mcasts 1360660', 'recv_errors 0', 'instance_name ifgrp_sto',
                'send_errors 0', 'send_data 323931282332034', 'recv_mcasts 1234567',
                ...
                'ipspace-name default-ipspace', 'mac-address 01:b0:89:22:df:02',
                'v4-primary-address.ip-address-info.creator vfiler:vfiler0', 'send_mcasts 166092',
                'recv_errors 0', 'instance_name ifgrp_srv-600', 'send_errors 0',
