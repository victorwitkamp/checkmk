...
@pytest.mark.parametrize("string_table, settings, items", [
    ...
    (
        [
            ...
            [
                'NODE1 ', ' 00:00:00:00:00:00 ', ' A_B-C_1 ', ' Ethernet1-XYZ ', ' 2 ',
                ' 10000000000 ', ' {FOO-123-BAR}'
            ],
        ],
        {
            'discovery_single': (
    ...
    ([['1559837585.63', '510', '2929686'], ['1', 'instances:', 'vmxnet3_Ethernet_Adapter'],
      ['-122', '38840302775', 'bulk_count'], ['-110', '206904763', 'bulk_count'],
      ['-244', '173589803', 'bulk_count'], ['-58', '33314960', 'bulk_count'],
      ['10', '10000000000', 'large_rawcount'], ['-246', '21145988302', 'bulk_count'],
      ['14', '36886547', 'bulk_count'], ['16', '136703256', 'bulk_count'],
      ['18', '0', 'large_rawcount'], ['20', '0', 'large_rawcount'],
      ['22', '0', 'large_rawcount'], ['-4', '17694314473', 'bulk_count'],
      ['26', '33127032', 'bulk_count'], ['28', '187928', 'bulk_count'],
      ['30', '0', 'large_rawcount'], ['32', '0', 'large_rawcount'],
      ['34', '0', 'large_rawcount'], ['1086', '0', 'large_rawcount'],
      ['1088', '0', 'large_rawcount'], ['1090', '0', 'bulk_count'],
      ['1092', '0', 'bulk_count'], ['1094', '0', 'large_rawcount']], {}, ['1']),
])
    ...
    assert list(
        winperf_if.discover_winperf_if(
            ...
            winperf_if.parse_winperf_if([
                ...
                [
                    '-122', '201612106', '187232778', '200985680546908', '969308895925',
                    'bulk_count'
                ],
                ...
                [
                    '10', '1000000000', '1000000000', '1000000000', '1000000000',
                    'large_rawcount'
                ],
                [
                    '-246', '189182492', '174803164', '200050287945665', '730174911',
                    'bulk_count'
                ],
                ...
                [
                    'LAN ', 'SwitchIndependent ', 'Dynamic ',
                    '38:63:BB:44:D0:24;38:63:BB:44:D0:25', 'nic1;nic2',
                ...
                [
                    'S5EXVM318 ', ' 38:63:BB:44:D0:26 ',
                    ' HPE Ethernet 1Gb 4-port 331i Adapter #3 ', ' nic3-vl302 ', ' 2 ',
                    ' 1000000000 ', ' {5FBD3455-980D-4AD6-BDEE-79B42B7BBDBC}'
                ],
                [
                    'S5EXVM318 ', ' 38:63:BB:44:D0:27 ',
                    ' HPE Ethernet 1Gb 4-port 331i Adapter #4 ', ' nic4-vl303 ', ' 2 ',
                    ' 1000000000 ', ' {8A1D9DD0-DF30-46CD-87FC-ACB13A5AB2BA}'
                ],
                [
                    'S5EXVM318 ', ' 38:63:BB:44:D0:24 ',
                    ' HPE Ethernet 1Gb 4-port 331i Adapter ', ' nic1 ', ' 2 ', '  ',
                    ' {4DA62AA0-8163-459C-9ACE-95B1E729A7DD}'
                ],
                [
                    'S5EXVM318 ', ' 38:63:BB:44:D0:25 ',
                    ' HPE Ethernet 1Gb 4-port 331i Adapter ', ' nic2 ', ' 2 ', '  ',
                    ' {FEF2305A-57FD-4AEC-A817-C082565B6AA7}'
                ],
                [
                    'S5EXVM318 ', ' 38:63:BB:44:D0:24 ',
                    ' Microsoft Network Adapter Multiplexor Driver ', ' LAN ', ' 2 ',
                    ' 2000000000 ', ' {69DCC9F6-FD98-474C-87F8-DD1023C6117C}'
                ],
            ]),
        )) == [
            Service(
...
IF_SECTION = [
    ...
    [
        '10', '1410065408', '1410065408', '100000', '100000', '100000', '100000', '100000',
        '100000', 'large_rawcount'
    ],
...
def test_winperf_if_parse_sections():
    winperf_if.parse_winperf_if(IF_SECTION + [
        ...
        [
            ...
            'Broadcom BCM57800 NetXtreme II 10 GigE (NDIS VBD Client)', 'NIC2', '2'
        ],
        ...
        [
            'NODE1', 'AA:AA:AA:AA:AA:AA',
            'Broadcom BCM57800 NetXtreme II 10 GigE (NDIS VBD Client)', 'NIC1', '2'
        ],
        ...
        [
            'NODE1', 'AA:AA:AA:AA:AA:AA', 'Microsoft Network Adapter Multiplexor Driver',
            '10GTeam', '2'
        ],
        ['NODE1', '', 'Hyper-V Virtual Switch Extension Adapter', '', ''],
        [
            'NODE1', 'AA:AA:AA:AA:AA:AA', 'Hyper-V Virtual Ethernet Adapter #2', 'Management',
            '2'
        ],
...
def winperf_if_teaming_parsed(time, out_octets):
    return (
        time,
        [
            # (('DAG-NET', '8'), 'Intel[R] Ethernet 10G 2P X520 Adapter 4', '6', 10000000000,
            #  ('1', 'Connected'), 145209040, 0, 0, 2099072, 0, 0, out_octets, 0, 0, 0, 0, 0, 0,
            #  'SLOT 4 Port 2 DAG', '\xa06\x9f\xb0\xb3f'),
            # (('DAG-NET', '3'), 'Intel[R] Ethernet 10G 2P X520 Adapter 2', '6', 10000000000,
            #  ('1',
            #   'Connected'), 410232131549, 376555354, 0, 225288, 0, 0, 1171662236873 + out_octets,
            #  833538016, 0, 63489, 0, 0, 0, 'SLOT 6 Port 1 DAG', '\xa06\x9f\xb0\xa3`'),
...
@pytest.mark.parametrize('string_table, discovery_results, items_params_results', [
    ...
    (
        [['1476804932.61', '510', '2082740'],
         ...
         [
             '-122', '246301064630', '2035719049115', '191138259305', '1956798911236',
             'bulk_count'
         ...
         ['-246', '85146916834', '295765890709', '28180136075', '244690096455', 'bulk_count'],
         ...
         ['22', '0', '0', '0', '0', 'large_rawcount'],
         [
             '-4', '161154147796', '1739953158406', '162958123230', '1712108814781',
             'bulk_count'
         ...
         ['1090', '0', '0', '0', '0', 'bulk_count'],
         ['1092', '0', '0', '0', '0', 'bulk_count'],
         ['1094', '0', '0', '0', '0', 'large_rawcount'], ['[teaming_start]'],
         [
             'TeamName', 'TeamingMode', 'LoadBalancingAlgorithm', 'MemberMACAddresses',
             'MemberNames', 'MemberDescriptions', 'Speed', 'GUID'
         ],
         [
             'T1Team ', 'Lacp ', 'Dynamic ', '00:00:00:00:00:00;00:00:00:00:00:01',
             'Ethernet 3;Ethernet 6', 'HP1 Adapter;HP1 Adapter #3', '10000000000;10000000000',
             '{123-ABC-456};{FOO-123-BAR}'
         ],
         [
             'T2Team ', 'Lacp ', 'Dynamic ', '00:00:00:00:00:02;00:00:00:00:00:03',
             'Ethernet 7;Ethernet 5', 'HP2 Adapter #52;HP2 Adapter #53', '1000000000;1000000000',
             '{BAR-456-BAZ};{1-A-2-B-3-C}'
         ], ['[teaming_end]'],
         [
             'Node', 'MACAddress', 'Name', 'NetConnectionID', 'NetConnectionStatus', 'Speed',
             'GUID'
         ],
         ['ABC123 ', '  ', ' HP2 Adapter ', ' Ethernet ', ' 4 ', '  ', ' {FOO_XYZ123-BAR}'],
         ['ABC123 ', '  ', ' HP2 Adapter ', ' Ethernet 2 ', ' 4 ', '  ', ' {987-ZYX-654}'],
         [
             'ABC123 ', ' 00:00:00:00:00:00 ', ' HP1 Adapter ', ' Ethernet 3 ', ' 2 ', '  ',
             ' {123-ABC-456}'
         ],
         ['ABC123 ', '  ', ' HP1 Adapter ', ' Ethernet 4 ', ' 4 ', '  ', ' {XYZ-FOO-123}'],
         [
             'ABC123 ', ' 00:00:00:00:00:01 ', ' HP2 Adapter ', ' Ethernet 5 ', ' 2 ', '  ',
             ' {1-A-2-B-3-C}'
         ],
         [
             'ABC123 ', ' 00:00:00:00:00:02 ', ' HP1 Adapter ', ' Ethernet 6 ', ' 2 ', '  ',
             ' {FOO-123-BAR}'
         ],
         [
             'ABC123 ', ' 00:00:00:00:00:03 ', ' HP2 Adapter ', ' Ethernet 7 ', ' 2 ', '  ',
             ' {BAR-456-BAZ}'
         ], ['ABC123 ', '  ', ' HP1 Adapter ', ' Ethernet 8 ', ' 4 ', '  ', ' {FOOBAR-123}'],
         [
             'ABC123 ', ' 00:00:00:00:00:04 ', ' Microsoft Network Adapter Multiplexor Driver ',
             ' T1Team ', ' 2 ', ' 20000000000 ', ' {456-FOOBAR}'
         ],
         [
             'ABC123 ', ' 00:00:00:00:00:05 ',
             ' Microsoft Network Adapter Multiplexor Driver #2 ', ' T2Team ', ' 2 ',
             ' 2000000000 ', ' {FOO-1-BAR-2-BAZ-3}'
         ]],
        [
            Service(
                item='1',
