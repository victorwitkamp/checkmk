...
AGENT_OUTPUT_1 = [
    ...
    [
        '127.0.0.1', 'None', 'ServerUptime:', '1', 'day', '23', 'hours', '17', 'minutes',
        '52', 'seconds'
    ], ['127.0.0.1', 'None', 'Load1:', '0.70'], ['127.0.0.1', 'None', 'Load5:', '0.66'],
    ['127.0.0.1', 'None', 'Load15:', '0.67'],
    ['127.0.0.1', 'None', 'Total', 'Accesses:', '64265'],
    ['127.0.0.1', 'None', 'Total', 'kBytes:', '105614'],
    ['127.0.0.1', 'None', 'CPUUser:', '.34'], ['127.0.0.1', 'None', 'CPUSystem:', '.15'],
    ...
    ['127.0.0.1', 'None', 'BusyWorkers:', '1'], ['127.0.0.1', 'None', 'IdleWorkers:', '49'],
