...
info = [
    ['HDD1', '37 C/98 F'], ['HDD2', '32 C/89 F'], ['HDD3', '40 C/104 F'],
    ['HDD4', '39 C/102 F'], ['HDD5', '45 C/113 F'],
    ['HDD6', '43 C/109 F']
]
    ...
    '': [
        ...
        (
            'HDD3', {
                ...
                (
                    1, '40.0 \xb0C (warn/crit at 40/45 \xb0C)', [
        ...
        (
            'HDD5', {
                ...
                (
                    2, '45.0 \xb0C (warn/crit at 40/45 \xb0C)', [
        ...
        (
            'HDD6', {
                ...
                (
                    1, '43.0 \xb0C (warn/crit at 40/45 \xb0C)', [
