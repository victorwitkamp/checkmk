    ...
    '': [
        (
            'Windows', {
                ...
                (0, 'Description: Name: Myname, Ip-Address: 1.1.1.1', []),
                ...
                ), (0, 'Mode: Exclusive ', []), (0, 'Offline: no', []),
                (
                    0, 'Average response time: 35.0 ms', [
                        ('avg_response_time', 0.035, None, None, None, None)
                    ]
                ),
                (
                    0, 'Clock difference: 8.00 ms', [
