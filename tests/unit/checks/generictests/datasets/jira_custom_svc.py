...
info = [
    [
        '{"Custom', 'Service":', '{"error":', '"Jira', 'error', '400:',
        'Error', 'in', 'the', 'JQL', 'Query:', "'for'", 'is', 'a',
        'reserved', 'JQL', 'word.', 'You', 'must', 'surround', 'it',
        'in', 'quotation', 'marks', 'to', 'use', 'it', 'in', 'a',
        'query.', '(line', '1,', 'character', '40)"}}'
    ],
    [
        '{"Custom', 'error":', '{"error":', '"Jira', 'error', '400:',
        'Error', 'in', 'the', 'JQL', 'Query:', 'Expecting', 'operator',
        'but', 'got', "'closed'.", 'The', 'valid', 'operators', 'are',
        "'=',", "'!=',", "'<',", "'>',", "'<=',", "'>=',", "'~',",
        "'!~',", "'IN',", "'NOT", "IN',", "'IS'", 'and', "'IS",
        "NOT'.", '(line', '1,', 'character', '30)"}}'
    ],
    [
        '{"Jira', 'custom', '2":', '{"count":', '414},', '"Custom',
        'avg":', '{"avg_sum":', '37.0,', '"avg_total":', '50,', '"avg":',
        '"0.74"},', '"Custom', 'sum":', '{"sum":', '37.0}}'
    ]
]

discovery = {
    '': [
        ('Custom Avg', {}), ('Custom Error', {}), ('Custom Service', {}),
        ('Custom Sum', {}), ('Jira Custom 2', {})
    ]
}
