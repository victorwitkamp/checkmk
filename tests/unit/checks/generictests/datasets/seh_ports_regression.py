...
info = [[['2.0', '20848_Ent_GNSMART2', '010.099.005.209', '15'],
...
discovery = {
    '': [
        ('10', {
            'status_at_discovery': '010.028.103.078'
        }),
        ('12', {
            'status_at_discovery': '010.099.005.202'
        }),
        ('13', {
            'status_at_discovery': '010.099.005.114'
        }),
        ('14', {
            'status_at_discovery': '010.099.005.102'
        }),
        ('15', {
            'status_at_discovery': '010.099.005.209'
        }),
        ('16', {
            'status_at_discovery': '010.099.005.207'
        }),
        ('17', {
            'status_at_discovery': 'SAPOS-Admin (010.099.005.204)'
        }),
        ('18', {
            'status_at_discovery': 'SAPOS-Admin (010.099.005.206)'
        }),
        ('19', {
            'status_at_discovery': '010.099.005.112'
        }),
        ('2', {
            'status_at_discovery': 'Available'
        }),
        ('20', {
            'status_at_discovery': 'ent.westphal (010.028.130.016)'
        }),
        ('3', {
            'status_at_discovery': 'SAPOS-Admin (010.099.005.205)'
        }),
        ('4', {
            'status_at_discovery': '010.028.103.077'
        }),
        ('5', {
            'status_at_discovery': '010.028.103.076'
        }),
        ('6', {
            'status_at_discovery': '010.028.103.075'
        }),
        ('7', {
            'status_at_discovery': 'SAPOS-Admin (010.099.005.208)'
        }),
        ('8', {
            'status_at_discovery': '010.099.005.111'
        }),
        ('9', {
            'status_at_discovery': 'SAPOS-Admin (010.099.005.203)'
        }),
    ]
}
